...
public class marronataquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marronataques);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.marronataques);
