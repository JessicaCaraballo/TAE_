...
public class azuldefensasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_azuldefensas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.azuldefensas);
