...
public class azulposicionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_azulposiciones);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.azulposiciones);
