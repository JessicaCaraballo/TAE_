...
public class ponercinturonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ponercinturon);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.ponercinturon);
        mToogle = new ActionBarDrawerToggle(this,mDrawerLayout,R.string.abrir,R.string.cerrar);
        mDrawerLayout.addDrawerListener(mToogle);
        mToogle.syncState();
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        NavigationView navigationView = (NavigationView) findViewById(R.id.navPonercinturon);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.historia:
                        ...
                        break;
                    case R.id.saludo:
                        Intent saludo = new Intent(getApplicationContext(), ponercinturonActivity.class);
