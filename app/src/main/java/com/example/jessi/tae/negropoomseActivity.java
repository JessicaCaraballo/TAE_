...
public class negropoomseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negropoomse);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.negropoomse);
