...
public class azulpatadasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_azulpatadas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.azulpatadas);
