...
public class verdeataquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verdeataques);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.verdeataques);
