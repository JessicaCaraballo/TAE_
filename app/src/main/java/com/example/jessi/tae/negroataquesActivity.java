...
public class negroataquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negroataques);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.negroataques);
