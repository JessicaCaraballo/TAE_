...
public class naranjaposicionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_naranjaposiciones);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.naranjaposiciones);
