...
public class verdepatadasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verdepatadas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.verdepatadas);
