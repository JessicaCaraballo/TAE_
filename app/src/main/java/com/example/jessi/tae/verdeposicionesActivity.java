...
public class verdeposicionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verdeposiciones);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.verdeposiciones);
