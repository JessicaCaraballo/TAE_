...
public class azulataquesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_azulataques);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.azulataques);
