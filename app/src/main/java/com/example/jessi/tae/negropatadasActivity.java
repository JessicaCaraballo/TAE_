...
public class negropatadasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negropatadas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.negropatadas);
