...
public class amarillodefensasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amarillodefensas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.amarillodefensas);
