...
public class verdedefensasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verdedefensas);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.verdedefensas);
